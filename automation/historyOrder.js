...
(async function homeTest() {
    ...
    try {
        ...
        let nguoiDung = await driver.findElement(By.xpath('/html/body/header/nav/ul/li[4]'));
        await nguoiDung.click();


        let donHangCuaBan = await driver.findElement(By.xpath('//*[@id="checkout"]/strong'));
        await donHangCuaBan.click();
